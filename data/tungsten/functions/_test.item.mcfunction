...
give @s wither_skeleton_skull{AttributeModifiers:[{AttributeName:"generic.luck",Name:"tungsten.head",Amount:-0.000000000001,Operation:0,UUID:[I;12,42069,-0,12],Slot:"head"}]}
give @s iron_chestplate{AttributeModifiers:[{AttributeName:"generic.luck",Name:"tungsten.chest",Amount:-0.000000000001,Operation:0,UUID:[I;12,42069,-0,13],Slot:"chest"}]}
give @s leather_leggings{AttributeModifiers:[{AttributeName:"generic.luck",Name:"tungsten.legs",Amount:-0.000000000001,Operation:0,UUID:[I;12,42069,-0,14],Slot:"legs"}]}
give @s netherite_boots{AttributeModifiers:[{AttributeName:"generic.luck",Name:"tungsten.feet",Amount:-0.000000000001,Operation:0,UUID:[I;12,42069,-0,15],Slot:"feet"}]}
