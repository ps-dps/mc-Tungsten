...
execute store result score .new tungsten.uid.offhand store result storage tungsten:item components.minecraft:attribute_modifiers.modifiers[{type:"minecraft:generic.luck",uuid:[I;12,42069,0,11]}].amount double 0.00000000000090949470177292282 run scoreboard players add .global tungsten.uid.offhand 1
