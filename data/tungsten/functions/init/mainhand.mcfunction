...
execute store result block 420692 0 694202 Items[0].tag.AttributeModifiers[{AttributeName:"generic.luck",UUID:[I;12,42069,0,10]}].Amount double 0.000000000001 run scoreboard players get .global tungsten.uid.mainhand
