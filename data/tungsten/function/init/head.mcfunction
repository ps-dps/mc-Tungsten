...
execute store result score .new tungsten.uid.head store result storage tungsten:temp c.attribute_modifiers.modifiers[{type:"minecraft:luck",id:"tungsten:head"}].amount double 0.0000000000009094947017729282 run scoreboard players add .global tungsten.uid.head 1
