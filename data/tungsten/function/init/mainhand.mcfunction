...
execute store result score .new tungsten.uid.mainhand store result storage tungsten:temp c.attribute_modifiers.modifiers[{type:"minecraft:luck",id:"tungsten:mainhand"}].amount double 0.0000000000009094947017729282 run scoreboard players add .global tungsten.uid.mainhand 1
